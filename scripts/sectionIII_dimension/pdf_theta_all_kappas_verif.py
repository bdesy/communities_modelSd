...
To display histograms with curves run this script to generate sample files 
then run 

figures/fig4_pdf_theta_all_kappas.py -v true

with appropriate file paths
...
for D in [5,4,3,2,1]:
    ...
    if dd=='pwl':
        filename = '../figures/data/D{}-gamma{}-beta{}.txt'.format(D, args.gamma, args.beta_ratio)
    elif dd=='exp':
        filename = '../figures/data/all-kappa-verif/exp-D{}-lambda{}-beta{}.txt'.format(D, kappa, args.beta_ratio)
